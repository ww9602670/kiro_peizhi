...
const PLATFORM_OPTIONS: { value: string; label: string; defaultUrl: string }[] = [
  { value: 'JND28WEB', label: 'JND网盘', defaultUrl: 'https://166test.com' },
  { value: 'JND282', label: 'JND2.0', defaultUrl: 'https://166test.com' },
];
...
export default function Accounts() {
  ...
  const [formPlatform, setFormPlatform] = useState<string>('JND28WEB');
          ...
          <form className="bind-form" onSubmit={handleBind}>
            ...
            <div className="bind-field">
              ...
              <select
                ...
                value={PLATFORM_OPTIONS.some(o => o.value === formPlatform) ? formPlatform : '__custom__'}
                onChange={(e) => {
                  ...
                  if (val === '__custom__') {
                    ...
                    setFormPlatformUrl(opt?.defaultUrl ?? '');
                  }
                }}
                disabled={formLoading}
              >
                ...
                <option value="__custom__">自定义盘口</option>
              </select>
              {!PLATFORM_OPTIONS.some(o => o.value === formPlatform) && (
                <input
                  type="text"
                  className="bind-input"
                  style={{ marginTop: 6 }}
                  ...
                  placeholder="输入自定义盘口类型，如 JND28NEW"
                  disabled={formLoading}
                />
              )}
            </div>
