...
DDL_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS shared_market_snapshots (
        ...
        market_data_state   TEXT NOT NULL DEFAULT 'shared_ok',
        draw_state          TEXT NOT NULL DEFAULT 'normal',
        close_countdown_sec INTEGER,
        open_countdown_sec  INTEGER,
        pre_issue           TEXT,
        open_result         TEXT,
        fetched_at          TEXT NOT NULL,
        next_normal_refresh_at TEXT,
    ...
    CREATE TABLE IF NOT EXISTS random_backtest_tasks (
        ...
        plans_json       TEXT NOT NULL,
        plan_set_id      INTEGER REFERENCES random_plan_sets(id),
        status           TEXT NOT NULL DEFAULT 'pending',
        total_issues     INTEGER DEFAULT 0,
        processed_issues INTEGER DEFAULT 0,
        result_json      TEXT,
