...
BOCAI_ALLOW_LEGACY_DESTRUCTIVE_RESET = _get_bool(
...
BOCAI_SHARED_DETECTOR_ENABLED = _get_bool(
    "BOCAI_SHARED_DETECTOR_ENABLED",
    True,
)
BOCAI_SHARED_DETECTOR_ACCOUNT = os.environ.get(
    "BOCAI_SHARED_DETECTOR_ACCOUNT",
    "jiance11",
).strip()
BOCAI_SHARED_DETECTOR_PASSWORD = os.environ.get(
